...
// Liste des catégories disponibles (à adapter selon votre application)
...
const getProductName = (productId: string): string => {
  // Idéalement, nous devrions avoir un cache des produits pour lesquels l'utilisateur a des alertes
  // Pour l'instant, retournons l'ID tronqué
...
onMounted(async () => {
  ...
  try {
    ...
    // Ici, on pourrait également charger les préférences newsletter actuelles de l'utilisateur
    // TODO: Implémenter l'appel API pour récupérer les préférences newsletter
